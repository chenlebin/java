...
<style>
  body{ 
	 background-image:url(duomeiti/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_202011221403363.jpg);
...
function tiaozhuan()
{
	alert("即将为您跳转查询结果界面,请稍后！")//将数据库中传输过来的余额进行显示暂时还没想好咋传先留着。
	}
...
<style> 
  ...
  #bg{
	  background-color:#97EC64;
	  }

</style>

<body onLoad="yz()">
<div><h1 align="center" style="color:#55DAF7">查询账户余额</h1></div>
<div class="zhuce">
<form action="cc?flag=queryyhye" method="post">

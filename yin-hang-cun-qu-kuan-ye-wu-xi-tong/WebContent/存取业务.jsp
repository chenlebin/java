...
<style>
  body{ 
	 background-image:url(duomeiti/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_202011221403366.jpg);
...
<body onLoad="yz()">
<div>
  <h1 align="center" style="color:#DDD693">存取款业务</h1></div>
<div class="zhuce">
<form action="cc?flag=cunqukuan" method="post">
...
<table width="495" border="1" id="bg">
  ...
  <tr>
    <td > <a  href="用户界面.jsp"><img src="duomeiti/返回主菜单.png"></a>银行卡卡号
      <input  type="text" id="kh"  name="kh1" size="20" >
  </td>
  </tr>
  <tr>
    <td>存取款金额
      <label for="textfield"></label>
      <input type="text" name="cqk1" id="cqk"  size="16" placeholder="存款为正，取款为负"></td>

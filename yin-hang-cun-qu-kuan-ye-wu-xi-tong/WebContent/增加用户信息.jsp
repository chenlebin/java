...
<div><h1 align="center" style="color:#E27CB1">*增加用户信息</h1></div>
<div class="zhuce">
<!-- 增加用户信息，并添加标志位addyh释义为增加用户。 -->
<form action="cc?flag=addyh" method="post" >

<table width="495" border="1" id="bg">
  <tr>
    <td width="485">
    <a  href="主页.jsp"><img src="duomeiti/返回主菜单.png"></a>类型  
        <label>

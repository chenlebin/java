...
<body onLoad="yz()">
<div><h1 align="center" style="color:#DDD693">放债汇总</h1></div>
<div class="zhuce">
<form action="cc?flag=queryzz" method="post">

<table width="495" border="1" id="bg">
    
  <tr>
    <td > <a  href="用户界面.jsp"><img src="duomeiti/返回主菜单.png"></a>债主名：
      <input  type="text" id="zz"  name="zz" size="8" >
  </td>
  </tr>

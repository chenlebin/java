...
<style>
  body{ 
	 background-image:url(duomeiti/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_202011221403361.jpg);
...
<body onLoad="yz()">
     <!-- <h1 style="color:#81BCE4">${mag}</h1> -->
<div><h1 align="center" style="color:#E27CB1">借款项目</h1></div>
<div class="zhuce">
<!-- 增加借款信息，并添加标志位addyh释义为增加用户。 -->
<form action="cc?flag=jk" method="post" >

<table width="495" border="1" id="bg">
  <tr>
    <td width="485">
        <a  href="主页.jsp"><img src="duomeiti/返回主菜单.png"></a>
                   债主
  ...
  <tr>
    <td>借款人
      <label for="textfield"></label>
      <input type="text" name="zh" id="zh" ></td>
  </tr>
  <tr>
    <td >借款日期<input  type="text" id="time"  name="time">
    <div id="yzm2"><span  id="yzzha"></span></div></td>
  </tr> 
  <tr>
    <td>借款金额
      <label for="textfield"></label>
      <input type="text" name="je" id="je" ></td>
  </tr>
  <tr>
    <td>利息
      <label for="textfield"></label>
      <input type="text" name="ll" id="ll" ></td>
  </tr>

...
<body onLoad="yz()">
<div><h1 align="center" style="color:#DDD693">还款项目</h1></div>
<div class="zhuce">
<form action="cc?flag=hk" method="post">

<table width="495" border="1" id="bg">
    
  <tr>
    <td > <a  href="用户界面.jsp"><img src="duomeiti/返回主菜单.png"></a>id
      <input  type="text" id="id"  name="id1" size="8" >
  </td>
  </tr>
  
  <tr>
    <td >还款金额
      <input  type="text" id="je"  name="je1" size="8" >
  </td>
  </tr>
  
  <tr>
    <td >还款日期
      <input  type="text" id="time"  name="time1" size="8" >
  </td>
  </tr>
  ...
  <tr> 
    <td style="text-align:center;"><input type="submit" name="tijiao" id="tijiao" value="确认" style=" border-radius:30%; background-color:#4DA6FF; " onClick="tj()"></td>
  </tr>
